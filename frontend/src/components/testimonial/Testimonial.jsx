...
const TestimonialsSection = () => {
  ...
  return (
    <section className="sg-section sg-section-surface text-[#20232e] dark:bg-[#20232e] dark:text-white">
      <div className="absolute inset-0 sg-grid-pattern opacity-35 dark:opacity-10" />
      <div className="sg-shell relative z-10">
        <div className="grid gap-8 border-y border-[#20232e]/15 py-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-end dark:border-white/10">
          <div>
            <h2 className="sg-section-title font-black">Clear communication, technical depth, stronger defenses.</h2>
          </div>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1fr_0.42fr]">
          <div className="relative overflow-hidden border border-[#20232e]/20 bg-[#151718] p-6 text-white md:p-10">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-10 flex items-center gap-4">
                  <div className="flex h-16 w-16 items-center justify-center border border-white/15 bg-white text-[#20232e]">
            ...
            <div className="mt-10 flex items-center gap-3">
              <button onClick={prevTestimonial} className="border border-white/20 p-3 transition hover:border-[#00B51D]" aria-label="Previous testimonial">
                <FiChevronLeft />
              </button>
              <button onClick={nextTestimonial} className="border border-white/20 p-3 transition hover:border-[#00B51D]" aria-label="Next testimonial">
                <FiChevronRight />
              </button>
            </div>
          </div>
          ...
          <div className="grid gap-4">
            {testimonials.map((testimonial, index) => (
              ...
              activeIndex === index
                ...
                : 'border-[#20232e]/15 bg-[#fffdf8] hover:border-[#0068B8] dark:border-white/10 dark:bg-white/5'
            }`}
          >
                <p className="text-xl font-bold text-[#20232e] dark:text-white">{testimonial.highlight}</p>
                <p className="mt-2 text-sm text-[#5d6568] dark:text-white/50">{testimonial.name}</p>
              </button>
            ))}
          </div>
        </div>
